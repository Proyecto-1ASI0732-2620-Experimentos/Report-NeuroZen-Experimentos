...
<div>
  ...
  <p align="center"><b>Periodo: 2026-20</b></p>
  <p align="center">Código del curso: 1ASI0732</p>
  <p align="center">Nombre del curso: Diseño de Experimentos de Ingeniería de Software</p>
  <p align="center">NRC: 9100</p>
...
| :--- | :--- | :--- |
| **4.c.1 Reconoce responsabilidad ética y profesional en situaciones de ingeniería de software** | **Castro Picón, Manuel Fernando Joao:** Diseñó la arquitectura de software y la base de datos asegurando la privacidad de los datos de salud y perfiles biométricos de los usuarios en el AV1[cite: 1].<br><br>**Huaman De La Cruz, Jean Pool:** Implementó módulos del Frontend Web Application en el AV1, garantizando una experiencia de usuario segura y un manejo ético de las sesiones de los psicólogos[cite: 1].<br><br>**Paredes Chavez, Carlos Augusto:** Configuró el contexto de *Auth & Profile* durante el AV1, asegurando que el registro y el manejo de datos personales cumplan con los estándares éticos de privacidad[cite: 1].<br><br>**Requena Gutiérrez, Diego Gabriel:** Diseñó el *Dashboard & Navigation* en el AV1, aplicando principios éticos para que el usuario visualice sus métricas de estrés de forma segura[cite: 1].<br><br>**Vila Guillen, Miguel Angel:** Desarrolló los *endpoints* de la API para el *Service Booking* en el AV1, siguiendo convenciones de código profesional y asegurando transacciones seguras[cite: 1]. | **AV1:** Como equipo, logramos establecer una sólida base ética y profesional en el desarrollo del sistema NeuroZen. Garantizamos la confidencialidad de la información médica y biométrica de los trabajadores mediante una arquitectura segura, interfaces confiables y el cumplimiento de estándares de codificación, reflejando nuestra máxima responsabilidad técnica con la privacidad de los usuarios y especialistas[cite: 1]. |
| **4.c.2 Emite juicios informados considerando el impacto de las soluciones de ingeniería de software en contextos globales, económicos, ambientales y sociales** | **Castro Picón, Manuel Fernando Joao:** Evaluó el impacto económico en el *Startup Profile* (AV1), determinando que NeuroZen aumentará la productividad y reducirá el ausentismo laboral[cite: 1].<br><br>**Huaman De La Cruz, Jean Pool:** Analizó el impacto social en el AV1 al estructurar las *User Personas*, enfocándose en cómo el estrés afecta la calidad de vida de los profesionales[cite: 1].<br><br>**Paredes Chavez, Carlos Augusto:** Realizó el análisis competitivo de la plataforma en el AV1, evaluando el impacto global de soluciones de salud mental existentes en el mercado digital[cite: 1].<br><br>**Requena Gutiérrez, Diego Gabriel:** Diseñó el *Impact Mapping* en el AV1, emitiendo juicios sobre el impacto social en el segmento vulnerable de trabajadores informales[cite: 1].<br><br>**Vila Guillen, Miguel Angel:** Planificó la infraestructura tecnológica (*Deployment Configuration*) en el AV1, tomando decisiones informadas para un despliegue en la nube eficiente y ambientalmente responsable[cite: 1]. | **AV1:** El grupo ha demostrado capacidad para analizar el entorno integral de NeuroZen, concluyendo que la plataforma tendrá un impacto social y económico positivo al reducir el estrés laboral crónico, mejorar la productividad empresarial y brindar apoyo accesible a distintos segmentos de trabajadores. Asimismo, tomamos decisiones tecnológicas conscientes para minimizar la huella ambiental mediante un despliegue optimizado en la nube[cite: 1]. |
...
| ------------------------------------------------------- | --------------------------------- | ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![Joao](assets/cap1/members/joao-castro.jpeg)    | Manuel Fernando Joao Castro Picón | Ingeniería de Software | Tengo 20 años y curso el 7to ciclo en la Universidad Peruana de Ciencias Aplicadas. Me gusta entrenar calistenia, escuchar música y jugar fútbol. Me considero responsable, adaptable al trabajo en equipo y con metas claras para ser un gran profesional. |
| ![Carlos](assets/cap1/members/carlos-paredes.png)    | Carlos Augusto Paredes Chavez | Ingeniería de Software | Soy estudiante de Ingeniería de Software con experiencia en proyectos de desarrollo, documentación técnica y trabajo colaborativo con Git y GitHub. Me interesa fortalecer mis conocimientos en pruebas de software, aseguramiento de calidad, DevOps e integración continua. Me considero responsable, constante y orientado a desarrollar soluciones bien estructuradas y alineadas con las necesidades de los usuarios. |
| ![Miguel](assets/cap1/members/miguel-vila.jpeg)  | Miguel Angel Vila Guillen         | Ingeniería de Software | Tengo 21 años y estudio el 7to ciclo en la Universidad Peruana de Ciencias Aplicadas. Me gusta jugar videojuegos, tocar la guitarra y el fútbol. Me considero capaz de trabajar en equipo y aspiro a ser un profesional competente.                         |
| ![Diego](assets/cap1/members/diego-requena.jpeg) | Diego Gabriel Requena Gutiérrez   | Ingeniería de Software | Tengo 20 años y curso el 7to ciclo en la Universidad Peruana de Ciencias Aplicadas. Soy una persona comprometida con mis objetivos, busco optimizar mi rendimiento y mantener un equilibrio entre la excelencia y una vida saludable.                       |
| ![JeanPool](assets/cap1/members/jeanpool.jpg)    | Huaman De La Cruz Jean Pool       | Ingeniería de Software | Tengo 23 años; Estoy cursando la carrera de ingeniería de software en quinto ciclo. Soy una persona orientada a objetivos y con una meta clara, quiero poder crear soluciones disruptivas que revolucionen el mercado.                                      |
...
<div>
  <p align="center"><img src="assets/cap2/empathy-map/Empathy-1.png" alt="Empathy mapping part 1" width="700px" /></p>
</div>

<div>
  <p align="center"><img src="assets/cap2/empathy-map/Empathy-2.png" alt="Empathy mapping part 2" width="700px" /></p>
</div>

<div>
  <p align="center"><img src="assets/cap2/empathy-map/Empathy-3.png" alt="Empathy mapping part 3" width="700px" /></p>
</div>

<div>
  <p align="center"><img src="assets/cap2/empathy-map/Empathy-4.png" alt="Empathy mapping part 4" width="700px" /></p>
</div>
...
<div>
  <p align="center"><img src="assets/cap2/impact-map/ImpactMapping_s1.png" alt="Impact mapping segmento 1" width="700px" /></p>
</div>

Impact Mapping - Segmento 2

<div>
  <p align="center"><img src="assets/cap2/impact-map/ImpactMapping_s2.png" alt="Impact mapping segmento 2" width="700px" /></p>
</div>
...
<div>
  <p align="center"><img src="assets/cap3/neurozen-logos/logo.png" alt="Neurozen's main logo" width="250px" /></p>
</div>
...
<div>
  <p align="center"><img src="assets/cap3/colors/verdebosque.png" alt="Forest green color" width="450px" /></p>
</div>
...
<div>
  <p align="center"><img src="assets/cap3/colors/verdementa.png" alt="Mint green color" width="450px" /></p>
</div>
...
<div>
  <p align="center"><img src="assets/cap3/colors/beigecalido.png" alt="Warm beige color" width="450px" /></p>
</div>
...
<div>
  <p align="center"><img src="assets/cap3/colors/turquesa.png" alt="Deep turquoise color" width="450px" /></p>
</div>
...
<div>
  <p align="center"><img src="assets/cap3/colors/grispiedra.png" alt="Pale gray color" width="450px" /></p>
</div>
...
<div>
  <p align="center"><img src="assets/cap3/neurozen-logos/neurozen1.png" alt="Neurozen logo v-2" width="250px" /></p>
</div>
-Una opción minimalista, sin muchos detalles y relajante a la vista.
<div>
  <p align="center"><img src="assets/cap3/neurozen-logos/neurozen2.png" alt="Neurozen logo v-3" width="250px" /></p>
</div>
-Una opción con mejor detalle y uso de colores.
<div>
  <p align="center"><img src="assets/cap3/neurozen-logos/neurozen3.png" alt="Neurozen logo v-4" width="250px" /></p>
</div>
-Una representación más abstracta que inspira relajación.
<div>
  <p align="center"><img src="assets/cap3/neurozen-logos/neurozen4.png" alt="Neurozen logo v-5" width="250px" /></p>
</div>
